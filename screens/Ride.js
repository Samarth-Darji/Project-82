...
export default class RideScreen extends Component {
    ...
    handleTransaction = async () => {
        var { bikeId, userId, bikeType, userName } = this.state;
        ...
        if (!transactionType) {
            ...
            var isEligible = await checkUserEligibilityForStartRide();
            ...
            var Eligible = await checkUserEligibilityForEndRide();
    ...
    checkUserEligibilityForEndRide = async (bikeId, userId) => {
        ...
        transactionRef.docs.map((doc) => {
            ...
            if (lastBikeTransaction.id == this.state.userId) {
                isUserEligible = true;
            } else {
                isUserEligible = false;
